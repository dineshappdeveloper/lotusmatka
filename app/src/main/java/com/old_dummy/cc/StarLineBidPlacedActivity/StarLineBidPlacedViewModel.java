...
public class StarLineBidPlacedViewModel implements StarLineBidPlacedContract.ViewModel{
    @Override
    public void callApi(OnFinishedListener onFinishedListener, String token, String serverData, View view) {
        Call<CommonModel> call = ApiClient.getClient().starlinePlaceBid(token, serverData);
