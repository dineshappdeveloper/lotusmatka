...
public class NoticePresenter implements NoticeContract.Presenter, NoticeContract.ViewModel.OnFinishedListener {
    NoticeContract.View view;
    NoticeContract.ViewModel viewModel;
